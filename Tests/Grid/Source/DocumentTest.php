...
class DocumentTest extends TestCase
{
    ...
    public function testExecuteWithFiltersOnSubColumns($operator, $method, $filterValue, $params)
    {
        ...
        $helperBuilder = $this->createMock(Builder::class);
        $helperBuilder
            ->method('field')
            ->with($subCol)
            ->willReturn($helperBuilder);
        $helperBuilder
            ->method('getQuery')
            ->willReturn($helperQuery);
    ...
    public function testExecuteWithoutPrimaryColumnDataDisjunctionAndNotFiltered()
    {
        ...
        $filterEq = $this->createMock(Filter::class);
        $filterEq
            ->method('getOperator')
            ->willReturn(Column::OPERATOR_EQ);
        $filterEq
            ->method('getValue')
            ->willReturn($filterEqValue);
